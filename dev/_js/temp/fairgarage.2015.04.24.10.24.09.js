    ...
    window.fg = function(fgObj){
        ...
        */
        ...
        /** 
          ...
          * @param {object} pobj
              * @param {object} criteria (opt) - search criteria; for more details, please refer to the description in http://www.fairgarage.de/smp/apitester/
                  * @param {string} countryCode (opt) - code of the country
        ...
        */
        self.findLocation = function(pobj){
            ...
            var obj = {
                url: 'locations',
                urlParam: $.extend({context:self.properties.contextKey},criteria),
                data: JSON.stringify(findContextData),
        ...
        /** 
          ...
          * @param {object} pobj
              * @param {object} criteria (opt) - search criteria; for more details, please refer to the description in http://www.fairgarage.de/smp/apitester/
                  ...
                  * @param {string} vehicleTypeId (opt) - ID of the vehicle type
