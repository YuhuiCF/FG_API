...
(function($){
    ...
    window.fg = function(fgObj){
        ...
        */
        ...
        /** 
          * @desc get FairGarage agreements
          * @param object pobj
        ...
        */
        self.getAgreement = function(pobj){
            ...
            var obj = {
                url: 'agreements',
                data: {providerId:1,isPublik:true},
        ...
        /** 
          ...
          * @param object pobj
              * @param string registrationData - data of registration; for more details, please refer to the description in http://www.fairgarage.de/smp/apitester/
                  ...
                  * @param array of objects, the agreement objects can be obtained by getAgreement acceptedAgreements - accepted agreements
              * @param (opt) object ajax - key/value pairs of jQuery ajax() to be added/overwritten, if allowed
        */
        self.registerUser = function(pobj){
            ...
            if (typeof registrationData.acceptedAgreements == 'undefined') {
                self.error('Please indicate the "acceptedAgreements" of type array of objects, the agreement objects can be obtained by getAgreement in "registrationData" in function registerUser()');
                return;
            }
            var obj = {
                url: 'users',
        ...
        */
        self.getVehicleByCatalog = function(pobj){
            ...
            var obj = {
                ...
                data: (constructionTime ? {constructionTime: constructionTime} : ''),
                success: function(data){
                    if (typeof quickHandle == 'function') {
                        var newData = [];
                        var key;
