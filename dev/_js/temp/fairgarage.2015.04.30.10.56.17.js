...
(function($){
    ...
    window.fg = function(fgObj){
        ...
        */
        ...
        /** 
          ...
          * @param {object} pobj
              ...
              * @param {object} criteria - other search criteria
                  * @param {boolean} generateEmpty (API url parameter) - whether locations with no offer will be included in the result list
              * @param {object} ajax (opt) - key/value pairs of jQuery ajax() to be added/overwritten, if allowed
        */
        self.createOfferSearch = function(pobj){
            ...
            if (typeof criteria.generateEmpty == 'undefined') {
                paramMissingHint.push('"generateEmpty" of type "boolean" in "criteria"');
            }
            if (paramMissingHint.length > 0) {
        ...
        */
        ...
        /** 
          * @desc find vehicle by documents, API base path: /smp/api/vehicles/vehicletypes, API full path: /smp/api/vehicles/vehicletypes
          * @param {object} pobj
              * @param {object} criteria (opt) - search criteria; for more details, please refer to the description in http://www.fairgarage.de/smp/apitester/
