    ...
    window.fg = function(fgObj){
        ...
        */
        self.api = function(obj){
            ...
            var url = ((self.properties.ssl == 'https' || self.properties.ssl == 'http') ? self.properties.ssl : '') + '//' + self.properties.env + self.properties.apiBase + (obj.url || 'authentication/login') + (self.properties.sessionId ? ';jsessionid=' + self.properties.sessionId : '') + ('?contextKey=' + self.properties.contextKey + '&languageCode=' + self.properties.languageCode);
        ...
        self.login = function(pobj){
            ...
            var obj = {
                ...
                success: function(data){
                    private.sessionId = data.user.sessionId;
